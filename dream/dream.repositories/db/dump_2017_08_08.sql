...
CREATE TABLE `currency` (
  ...
  `dateLastModified` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
insert  into `currency`(`id`,`activeFlag`,`code`,`name`,`homeCurrencyFlag`,`rate`,`dateCreated`,`dateLastModified`,`lastChangedUserId`) values 
...
insert  into `location_group`(`id`,`activeFlag`,`name`,`description`,`dateCreated`,`dateLastModified`,`lastChangedUserId`) values 
(1,'','PHN','Phnom penhhead quater','2017-08-04 10:03:14','2017-08-04 10:03:14',0);
...
CREATE TABLE `part_cost` (
  ...
  `dateCreated` datetime NOT NULL,
  `dateLastModified` datetime NOT NULL,
  `lastChagnedUserId` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `vendor` (
  ...
  `minQtyOrderAmount` decimal(10,0) NOT NULL,
...
insert  into `vendor`(`id`,`accountId`,`statusId`,`activeFlag`,`name`,`note`,`currencyId`,`currencyRate`,`creditLimit`,`minQtyOrderAmount`,`leadTime`,`defaultPaymentTermId`,`defaultShipTermId`,`defaultCarrierId`,`url`,`taxRateId`,`dateCreated`,`dateLastModified`,`lastChangedUserId`) values 
(1,0,10,'','Vendor 1','Note',1,1,3000,100,20,1,10,1,'url.com',1,'2017-08-08 17:05:22','2017-08-08 17:05:22',0),
(2,25,10,'','Vendor 2','Note',1,1,3000,100,20,1,10,1,'url.com',1,'2017-08-08 17:06:22','2017-08-08 17:06:22',0);
